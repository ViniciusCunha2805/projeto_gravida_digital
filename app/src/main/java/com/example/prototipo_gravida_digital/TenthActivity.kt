...
class TenthActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnProxima.setOnClickListener {
            // Salva a resposta da pergunta (Pergunta 8)
            DatabaseHelper(this).apply {
                salvarRespostaUnica(
                    idUsuario = 1,  // ID temporário
                    numeroPergunta = 8,  // TenthActivity = Pergunta 8
                    valor = seekBar.progress
                )
                close()
            }

            // Navega para a tela final (EleventhActivity)
            ...
            imageCapture.takePicture(
                ...
                object : ImageCapture.OnImageSavedCallback {
                    override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                        ...
                        DatabaseHelper(this@TenthActivity).salvarFoto(
                            idUsuario = 1,
